<?php
	...
	$result = $r->ListCandidate($Candidate_ID, "published");

	if ( ! empty ($result)) {
		foreach ($result as $var) {
			if (! empty ($var)) {
				$PetitionData[1]["TotalPosition"] = $var["CandidateElection_Number"];
				$PetitionData[1]["PositionType"]	= $var["CandidateElection_PositionType"];
				$PetitionData[1]["CandidateName"]	= $var["Candidate_DispName"];
				$PetitionData[1]["CandidatePositionName"]	= $var["CandidateElection_PetitionText"];
				$PetitionData[1]["CandidateResidence"] = $var["Candidate_DispResidence"];
				$PetitionData[1]["Witness_FullName"][$var["CandidateWitness_ID"]] = $var["CandidateWitness_FullName"];
				$PetitionData[1]["Witness_Residence"][$var["CandidateWitness_ID"]] = $var["CandidateWitness_Residence"];
			}
		}
	}
	...
	$pdf->TodayDateText = "Date: March _______ , 2019";
