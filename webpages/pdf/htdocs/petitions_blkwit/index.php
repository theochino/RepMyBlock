...
//				if ( $var["Raw_Voter_ID"] == $RawVoterID) {
					...
					$pdf->WitnessName = "_________________________________________"; // $pdf->Candidate[$TotalCandidates];
					$pdf->WitnessResidence = "_________________________________________"; // $candidate_result["Candidate_DispResidence"];
	...
	$pdf->TodayDateText = "Date: July _________ , 2018";
  ...
  for ($i = 0; $i < $TotalCountName; $i++) {
  	...
  	$pdf->SetY($YLocation + 2);
		$pdf->Cell(38, 0, $Counter . ". July ____, 2018", 0, 0, 'L', 0);
